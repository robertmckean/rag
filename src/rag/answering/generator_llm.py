...
def _prompt_instructions_hybrid() -> str:
    return (
        ...
        "- When evidence spans multiple dates, include the created_at date for each excerpt as a chronological marker.\n"
        "- Only use names, places, and entities that appear verbatim in the evidence or query. Spell them exactly as they appear.\n"
        "- Do not infer, interpret, or conclude beyond what the evidence explicitly states.\n"
        "- Do not change the supplied answer_status.\n"
        "- When evidence is truncated or incomplete, say so — do not fill in the gap.\n"
        "- Evidence items marked author_role=user are the user's own words — prefer quoting these directly.\n"
        "- Cite every evidence item you reference. Do not reference evidence you do not cite.\n"
        "- Output valid JSON with keys answer_text and citation_ids only.\n"
        "- citation_ids must reference only the supplied evidence_id values.\n"
    )
...
_NON_ENTITY_WORDS = frozenset({
    ...
    "Will", "With", "Would",
    "Yet", "You", "Your",
    # --- Common verbs / verb forms that appear capitalized at sentence starts ---
    "Became", "Become", "Began", "Brought", "Built",
    "Called", "Came", "Caused", "Changed", "Coming", "Consider", "Continued",
    "Created",
    "Decided", "Described", "Did", "Documented", "Done", "Dropped",
    "Ended", "Explained", "Expected",
    "Feeling", "Felt", "Finally", "Fixed", "Focused", "Following", "Found",
    "Gave", "Get", "Getting", "Give", "Given", "Goes", "Going", "Gone", "Got",
    "Happened", "Having", "Heard", "Held", "Help", "Helped", "Hold",
    "Imagine", "Included", "Including",
    "Kept", "Knew", "Know", "Known",
    "Lead", "Left", "Let", "Like", "Looked", "Looking", "Lost",
    "Made", "Makes", "Making", "Managed", "Meant", "Mentioned", "Moved",
    "Need", "Needed", "Noticed",
    "Opened", "Organizing",
    "Played", "Pointed", "Pulled", "Put",
    "Ran", "Read", "Realized", "Remember", "Remembered", "Removed", "Replied",
    "Running",
    "Said", "Saw", "See", "Seeing", "Seems", "Seen", "Sent", "Set", "Show",
    "Showed", "Sit", "Speaking", "Spent", "Started", "Stay", "Stayed",
    "Stop", "Stopped",
    "Taken", "Talk", "Talking", "Taught", "Tell", "Telling", "Think",
    "Thinking", "Thought", "Told", "Took", "Tried", "Trying", "Turn", "Turned",
    "Understood", "Used", "Using",
    "Want", "Wanted", "Went", "Wonder", "Wondering", "Worked", "Wrote",
    # --- Common adjectives / adverbs capitalized at sentence starts ---
    "Absolutely", "Actually", "Already", "Always", "Anyway",
    "Bad", "Basically", "Best", "Better", "Big",
    "Certain", "Clearly", "Close", "Completely", "Current", "Currently",
    "Deep", "Definitely", "Different",
    "Earlier", "Enough", "Entire", "Especially", "Essentially", "Eventually",
    "Exactly", "Extremely",
    "Fair", "Far", "Few", "First", "Full", "Fully", "Funny",
    "Generally", "Good", "Great",
    "Honestly", "Hopefully", "Huge",
    "Important", "Incredibly", "Indeed", "Instead", "Interesting",
    "Kind",
    "Large", "Last", "Later", "Less", "Little", "Long",
    "Main", "Many", "Maybe", "Meanwhile", "Mostly",
    "Near", "Never", "New", "Next", "Nice",
    "Obviously", "Often", "Old", "Once", "Open", "Otherwise",
    "Partially", "Past", "Perhaps", "Possible", "Pretty", "Probably",
    "Quite",
    "Rather", "Real", "Really", "Recent", "Recently", "Right",
    "Seriously", "Several", "Similar", "Simply", "Slowly", "Small",
    "Somehow", "Sometimes", "Sort", "Strange", "Strong", "Sure", "Surely",
    "Terrible", "Totally", "True", "Truly", "Typically",
    "Usually", "Utterly",
    "Well", "Whole", "Wild", "Worse", "Wrong",
    "Yeah", "Yes",
    # --- Common nouns / pronouns that are not proper nouns ---
    "Anything", "Anyone",
    "Behaviors",
    "End", "Evil", "Evidence", "Everything", "Everyone", "Example",
    "Fact",
    "Herself", "Himself",
    "Integration", "Itself",
    "Myself",
    "Nothing", "Nobody",
    "Others",
    "Part", "Person", "Place", "Please", "Plus", "Point", "Problem",
    "Reason", "Result", "Review",
    "Situation", "Something", "Someone", "Stuff", "Summary",
    "Thanks", "Thing", "Things", "Top",
    "Understanding",
    "Way",
    # --- Prepositions / conjunctions capitalized at sentence starts ---
    "About", "Above", "Across", "After", "Against", "Along", "Although",
    "Among", "Around",
    "Based", "Before", "Behind", "Below", "Beneath", "Beside", "Besides",
    "Between", "Beyond",
    "Despite", "Down", "During",
    "Except",
    "Inside",
